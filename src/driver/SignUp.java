...
public class SignUp extends JPanel{
    ...
    SignUp(){
        ...
        //SetBounds for Label
        lbl1.setBounds(10,10,250,70);//FirstName
        lbl2.setBounds(10,80,250,70);//LastName
        lbl3.setBounds(10,150,250,70);//Gender
        lbl4.setBounds(10,220,250,70);//DOB
        lbl5.setBounds(10,290,250,70);//Car details
        lbl6.setBounds(10,360,250,70);//Driving experience
        lbl7.setBounds(10,430,250,70);//Address
        lbl8.setBounds(10,500,250,70);//City
        lbl9.setBounds(10,570,250,70);//Nationality
        lbl10.setBounds(10,640,250,70);//MobileNo
        lbl11.setBounds(10,710,250,70);//Email
        lbl12.setBounds(10,780,250,70);//Password
        lbl13.setBounds(10,850,250,70);//Re-Enter pass

        //SetBounds for textFields
        txtFld1.setBounds(270,10,250,70);//FirstName
        txtFld2.setBounds(270,80,250,70);//LastName
        txtFld3.setBounds(270,220,250,70);//DOB
        txtFld4.setBounds(270,360,250,70);//Driving Experience
        txtFld5.setBounds(270,430,250,70);//Address
        txtFld6.setBounds(270,500,250,70);//City
        txtFld7.setBounds(270,640,250,70);//Mobile No
        txtFld8.setBounds(270,710,250,70);//Email
        txtFld9.setBounds(270,780,250,70);//Password
        txtFld10.setBounds(270,850,250,70);//Re enter pass

        //setBounds for buttons
        btn1.setBounds(270,290,250,70);
        btn2.setBounds(270,920,250,70);

        //setBounds for Radio buttons
        radBtn1.setBounds(270,150,250,70);
        radBtn2.setBounds(520,150,250,70);
        radBtn3.setBounds(770,150,250,70);
